...
from site_page.views import question_detail, home, index_login, profile, answer_detail, edit_profile
from site_page.views import register, search, question, topic_page
